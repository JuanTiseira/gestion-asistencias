...
function AlumnosForm({ values, isEdit, onSubmit }) {
  ...
  const handleChange = (event) => {
    ...
    if (
      ...
      formik.setFieldValue('carreras', [
        ...formik.values.carreras,
        selectedCarrera,
      ]);
    } else {
  ...
  const select = () => {
    ...
    return (
      <MultipleAddSelect
        ...
        name="carreras"
        value={
          Array.isArray(formik.values.carreras) ? formik.values.carreras : []
        }
        onChange={(event) => {
