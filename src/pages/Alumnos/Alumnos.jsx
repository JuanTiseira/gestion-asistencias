...
import { getAlumnos, selectAlumnos, selectedAlumnoData } from '@/features/alumnos/alumnosSlice';
  ...
  return (
    ...
    sx={{
      ...
      <Box sx={{
        ...
        <Button variant="contained" color="success" onClick={() => navigate('/alumnos/agregar-alumno')}>
          Agregar Alumno
        </Button>
      </Box>
      <Stack
